...
<div class="box">
    ...
    <div class="box-body no-padding">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="comment_td">
                     ...
                     <td>
                        @if($count == 0)
                        @if(auth()->user()->can('fleet-driver-document-edit'))
                            <a href="{{ url('drivers/upload/document',[$driver->id,$item->id]) }}" class="fas fa fa-upload"></a>
                        @endif
                        @else
                        @if(auth()->user()->can('fleet-driver-document-view-image'))
                     ...
                     <td>
                        @if(auth()->user()->can('fleet-driver-document-toggle'))
                        @if($count > 0)
        ...
        <div class="form-group">
            <div class="col-12">
                @if(auth()->user()->can('driver-document-toggle') || auth()->user()->can('driver-document-edit'))
